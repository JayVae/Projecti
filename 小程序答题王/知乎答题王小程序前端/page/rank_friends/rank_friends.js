            ...
            if (t) console.warn(t); else if (a) {
                ...
                try {
                    for (var u, d = n[Symbol.iterator](); !(s = (u = d.next()).done); s = !0) {
                        var h = u.value;
                        h.matchName = e.GetMatchInfo(h.curMatch).name;
                    }
                } catch (t) {
                    c = !0, l = t;
                } finally {
                ...
                m.avatarUrl = i.mainData.role.userInfo.avatarUrl, m.matchName = f.name, m.star = f.star, 
                m.city = e.getCity(i.mainData.role.userInfo.province, i.mainData.role.userInfo.city), 
