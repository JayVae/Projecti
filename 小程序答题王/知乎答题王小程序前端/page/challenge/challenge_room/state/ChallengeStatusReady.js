...
}, l = (require("../../../../net/challengeNet"), require("stateNone.js")), r = require("../../../../util/util.js"), o = (require("../../../../const/consts.js"), 
require("../../../../const/notifyConsts.js")), s = require("../../../../util/Tween.js"), u = require("../../../../util/ChallengeRoomDataManager.js"), g = require("../../../../net/connectNotify.js"), h = require("../../template/liveConsts.js"), c = require("../../template/audienceViewController.js"), d = require("../../../../net/wsconnect.js"), p = getApp(), f = function(f) {
    ...
    return n(m, l), a(m, [ {
        ...
        value: function() {
            ...
            var t = u.getData();
            t.type = u.iAmAudience() ? "obChallenge" : "challenge", r.log("=========匹配成功，前往战斗，dontLeave = true"), 
            this.page.dontLeave = !0, wx.redirectTo({
                url: "/page/fight/fight?from=" + t.type,
                complete: function() {
                    setTimeout(function() {
                        e.btnLock = !1;
                    }, 100);
