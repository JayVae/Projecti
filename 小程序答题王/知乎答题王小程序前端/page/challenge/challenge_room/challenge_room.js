...
Page({
    ...
    onLoad: function(a) {
        e.showShareMenu(), this.intoWithOnLoad = !0, this.dontLeave = !1, wx.setNavigationBarTitle({
            title: t.curRoom.name || "群比赛"
        });
    },
    ...
    onShareAppMessage: function() {
        var e = this, a = void 0, i = {
            title: (a = t.getShareData(n.mainData.role.userInfo.nickName)).title,
            path: "/page/login/login?friendCode=" + n.mainData.role.shareCode + "&challenge=" + !0,
            imageUrl: a.imageUrl,
            from: "challenge"
        };
        return n.shareConf(i, !0, function() {
            e.setData({
                sharePromptViewVisible: !1
            });
        }, function() {
