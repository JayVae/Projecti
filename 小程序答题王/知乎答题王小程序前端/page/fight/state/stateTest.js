...
getApp()), n = function() {
    ...
    return e(n, [ {
        ...
        value: function() {
            ...
            F["resultViewData.expLineAni"] = x.export(), F["resultViewData.funcBntAni"] = d.export(), 
        ...
        value: function(t, e) {
            ...
            return t.call(function() {
                ...
                a.page.setData(l);
                var w = e.score, m = e.rivalScore, x = i.fastGet("scoreText", !0);
                x.wait(110), x.tweenCall(function(t) {
                    var e = {};
        ...
        value: function(t, e) {
            ...
            }), t.wait(1e3), t.tweenCall(function(t) {
                var e = {};
