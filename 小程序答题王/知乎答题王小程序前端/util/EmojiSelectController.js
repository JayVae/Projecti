...
}(), t = (require("./../util/util.js"), require("./../util/Tween.js"), require("./../net/fightNet.js")), a = (require("./../util/RoomDataManager.js"), 
require("./../util/PVERoomDataManager.js"), function() {
    function a(i, n) {
        var o = this;
        e(this, a);
        getApp();
        this.page = i, this.panelVisible = !1, this.emojiController = n, this.page.emojiSelectController_onTapClosedBtn = function(e) {
