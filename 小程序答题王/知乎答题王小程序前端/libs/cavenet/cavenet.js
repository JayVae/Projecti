...
require("../../const/consts.js"), require("../../const/modeConsts.js")), r = {
    ...
    return s(c, [ {
        ...
        value: function(e) {
            if (this.session) {
                if (this.session.state == r.recover) return;
                this.session.onOpen = void 0, this.session.onMessage = void 0, this.session.onClose = void 0, 
                this.session.onError = void 0, this.session.close();
            }
            return this.session = new i(), this.session.onOpen = this.onSocketOpen.bind(this), 
            this.session.onMessage = this.onSocketMessage.bind(this), this.session.onClose = this.onSocketClose.bind(this), 
            this.session.onError = this.onSocketClose.bind(this), this.session.connect(this.wsURL);
        }
    }, {
        key: "request",
        value: function(e, s) {
